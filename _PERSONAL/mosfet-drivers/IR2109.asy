...
SYMATTR Value IR2109
SYMATTR ModelFile ..\sym\_PERSONAL\mosfet-drivers\IR2109.sub
SYMATTR SpiceModel IR2109
SYMATTR Prefix X
SYMATTR Description IR2109 is a high voltage, high speed power MOSFET driver with independent high and low side referenced output channels. Vmax = 600V, Vcc = 10V to 20V
PIN -112 -96 LEFT 8
PINATTR PinName 1
